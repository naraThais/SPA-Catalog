...
MapTo('catalogo/components/download')(DownloadV1, {isEmpty: DownloadV1IsEmptyFn});
MapTo('catalogo/components/list')(ListV2, {isEmpty: ListV2IsEmptyFn});
MapTo('catalogo/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});

MapTo('catalogo/components/button')(ButtonV1, {isEmpty: ButtonV1IsEmptyFn});
MapTo('catalogo/components/teaser')(TeaserV1, {isEmpty: TeaserV1IsEmptyFn});
MapTo('catalogo/components/image')(ImageV2, {isEmpty: ImageV2IsEmptyFn});
MapTo('catalogo/components/title')(TitleV2, {isEmpty: TitleV2IsEmptyFn});


MapTo('catalogo/components/breadcrumb')(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('catalogo/components/navigation')(NavigationV1);
MapTo('catalogo/components/languagenavigation')(LanguageNavigationV1);


MapTo('catalogo/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
MapTo('catalogo/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
MapTo('catalogo/components/carousel')(CarouselV1, {isEmpty: CarouselV1IsEmptyFn});
